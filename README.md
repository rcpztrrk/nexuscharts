...
- Demo now supports benchmark mode for large datasets (50k+), selectable generated/CSV adapter data sources, and annotation snapshot save/restore controls.
...
- Development demo page served from `public/`, including dataset benchmark mode, CSV adapter source selection, annotation snapshot controls, and Midnight/Ocean/Ember/Light/Terminal theme presets.
