...
- Demo now supports benchmark mode for large datasets (50k+) and selectable generated/CSV adapter data sources.
...
- Development demo page served from `public/`, including dataset benchmark mode, CSV adapter source selection, and Midnight/Ocean/Ember/Light/Terminal theme presets.
